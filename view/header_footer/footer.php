...
<footer class="d-flex col-12 justify-content-between bg-dark bleh">
    <div class="d-flex flex-column col-6 col-md-4 border border-dark">
        ...
        <p class="text-light">consentie est strictement interdite
    ...
    <div class="d-flex flex-column col-4 border border-dark d-none d-md-block">
        ...
        <ul>
            ...
            <li class="d-none d-lg-block"><a href="mailto:isabelle.mitoire@afpa.fr?subject=Ou%20est%20mon%20pognon%20?"
                                             class="text-info" title=" bon sang j'suis pauvre">La personne grâce à qui
                    je n'ai toujours pas été payé au bout de deux mois.</a></li>
        </ul>
    </div>
</footer>
