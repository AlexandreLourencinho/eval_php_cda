    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="d-flex flex-row">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li>
                        <a class="nav-link text-light" href="/view/connexion.php" title="Accès à la liste des diques"><i class="fas fa-sign-in-alt"></i> Se connecter</a>
                    </li>
                </ul>
            </div>
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li>
                        <a class="nav-link text-light" href="/view/creation_compte.php" title="Accès à la liste des diques"><i class="fas fa-user-circle"></i> Créer un compte</a>
                    </li>
                </ul>
            </div>
        </div>
