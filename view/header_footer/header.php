        ...
        <div class="d-flex flex-row">
            ...
            if (isset($_SESSION['login'])) { ?>
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        <li>
                            <a class="nav-link text-light" href="/view/mon_compte.php"
                               title="Accès à la liste des diques">
                                Bonjour <?= $_SESSION['login'] ?> !</a>
                        </li>
                    </ul>
                </div>
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        <li>
                            <a class="nav-link text-light" href="/view/destroy.php"
                               title="Accès à la liste des diques">
                                Se déconnecter</a>
                        </li>
                    </ul>
